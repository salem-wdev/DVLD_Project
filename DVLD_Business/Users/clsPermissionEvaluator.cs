...
namespace DVLD_Business.Users
{
    ...
    public class clsPermissionEvaluator
    {
        ...
        public static bool HasPermission(int userID, enUserPermissions permissionToCheck)
        {
            ...
            enUserPermissions userPermissionsValue = clsUser.GetUserPermissions(userID);
